...
namespace D04_OOP_Abstraction
{
    public abstract class Course
    {
        ...
        // Abstract Method ---> Método que não tem implementação, só tem assinatura
        //                 ---> tem de ser implementado na classe derivada
        //                 ---> obriga a que a classe seja abstract

        public abstract void Billing(string message);
        #endregion
